...
export const CourseCard: React.FC<CourseCardProps> = ({ course, onOpenModal }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Front Side */}
        <div className="absolute inset-0 w-full h-full backface-hidden rounded-[2.5rem] p-8 md:p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl flex flex-col justify-between overflow-hidden group-hover:shadow-2xl group-hover:shadow-emerald-500/10 transition-all">
          {/* ATM Style Chip/Icon Area */}
          <div className="flex justify-between items-start mb-6">
            <div className="w-16 h-16 rounded-2xl bg-emerald-600/10 dark:bg-emerald-500/20 flex items-center justify-center text-emerald-600 dark:text-emerald-400 border border-emerald-600/20 shadow-inner">
          ...
          <div className="flex-grow">
            <h3 className="text-2xl md:text-3xl font-black text-slate-900 dark:text-white mb-4 tracking-tight leading-tight group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
              {course.title}
            </h3>
          ...
          <div className="mt-8 pt-8 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
            ...
            <div className="bg-emerald-600 text-white p-3 rounded-xl shadow-lg shadow-emerald-600/20 group-hover:scale-110 transition-transform">
          ...
          <div className="absolute bottom-0 left-0 w-24 h-24 bg-teal-600/5 blur-2xl rounded-full -ml-12 -mb-12" />
        </div>
        ...
        >
          <div>
            ...
            <h4 className="text-emerald-400 font-black text-xs uppercase tracking-[0.2em] mb-6">Skills Covered</h4>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-emerald-600/10 text-emerald-500 border border-emerald-500/20 py-4 rounded-2xl font-black text-lg hover:bg-emerald-600 hover:text-white transition-all flex items-center justify-center gap-3 group/btn relative z-10"
            >
            ...
            <Link
              ...
              className="w-full bg-emerald-600 text-white py-4 rounded-2xl font-black text-lg hover:bg-emerald-700 transition-all shadow-2xl shadow-emerald-600/30 flex items-center justify-center gap-3 group/btn relative z-10"
            >
          ...
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-teal-500/10 blur-2xl rounded-full -ml-16 -mb-16" />
        </div>
      </motion.div>
    </div>
  );
